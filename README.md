...
## Download DaemonCore Academy 8.0.3

- [Linux AppImage](https://github.com/DaemoncoreApps/DaemonCore-Downloads/releases/download/v8.0.3/DaemonCore-Academy-8.0.3.AppImage)
- [Linux Debian package](https://github.com/DaemoncoreApps/DaemonCore-Downloads/releases/download/v8.0.3/DaemonCore-Academy-8.0.3.deb)
- [SHA-256 checksums](https://github.com/DaemoncoreApps/DaemonCore-Downloads/releases/download/v8.0.3/SHA256SUMS-linux.txt)
- [Linux support matrix](https://github.com/DaemoncoreApps/DaemonCore-Downloads/releases/download/v8.0.3/LINUX-SUPPORT-MATRIX.txt)
...
DaemonCore Academy remains free. FieldOps professional features and Cloud Classroom educator features are separate, optional services.
